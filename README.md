...
[image55]: image/RTAB_MAP.gif "Rtabmap"
![alt text][image55]
...
To setup the [RTAB-Map setup](http://wiki.ros.org/rtabmap_ros/Tutorials/SetupOnYourRobot), it recommended robot configuration requires:
